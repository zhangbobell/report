...
<option id="group" value="<?php echo $groupLine['groupid'] ?>" 
        <?php 
            if($groupLine['groupid'] === $user['groupid'] )
            {
                echo 'selected="selected"';
            }
        ?>
        ><?php echo $groupLine['group'] ?></option>
<?php endforeach; ?>
</select>
<br />
...
<option id="auth-project" value="<?php echo $projectLine['pid'] ?>" 
        <?php 
            if(in_array($projectLine['pid'], $authProject))
            {
                echo 'selected="selected"';
            }
        ?>
         ><?php echo $projectLine['projectname'] ?></option>
<?php endforeach; ?>
</select>
<br />
