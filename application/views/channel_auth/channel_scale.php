...
<div class="mt10">
    ...
    <div class="num-b">
        ...
        <div class="l-num curr" id="order_sales_fee_success"></div>
        <div class="l-num curr" id="order_sales_num_success"></div>
        <div class="fix"></div>
    </div>
    <div class="num-b">
        <div class="l-num-title">授权分销商数量</div>
        <div class="l-num-title">在架授权分销商数量</div>
        <div class="l-num curr" id="seller_num"></div>
        <div class="l-num curr" id="up_seller_num"></div>
        <div class="fix"></div>
    </div>
    <div class="fix"></div>
</div>